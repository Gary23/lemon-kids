...
家长登录/注册并创建家庭，管理孩子、任务模板、分类、回收站、奖励与设备使用信息、远程闹钟，并生成孩子任务端或监控端绑定码。
...
- 主 Tab 为 `tasks`、`alarm`、`monitor`、`profile`。闹钟是独立页签，不能放入监控页；编辑、家庭管理、分类、回收站和设备日志都是子路由。
